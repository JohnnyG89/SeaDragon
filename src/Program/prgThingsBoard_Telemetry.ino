...
void cyclicThingsBoard_Telemetry(void) {
  ...
  switch (MessageRecordToSend) {
    case 0: //oFreshwaterLightOutput
      ret = tb.sendTelemetryBool(		"oFreshwaterLightOutput", 		!oFreshwaterLight);
    ...
    case 27: //iTemperature_Smoothed
      ...
      break;
    case 28: //imode_Auto
      ret = tb.sendTelemetryBool(		"imode_Auto", 					imode_Auto);
      tbtlmLog.verbose("ThingsBoard_Telemetry:: Msg %d :: Sent Data To %s :: Channel %s :: Value %T ::", ii,   THINGSBOARD_SERVER, 	"imode_Auto", 				imode_Auto);
      break;
    case 29: //imode_manSkimmer
      ret = tb.sendTelemetryBool(		"imode_manSkimmer", 			imode_manSkimmer);
      tbtlmLog.verbose("ThingsBoard_Telemetry:: Msg %d :: Sent Data To %s :: Channel %s :: Value %T ::", ii,   THINGSBOARD_SERVER, 	"imode_manSkimmer", 		imode_manSkimmer);
      break;
    case 30: //imode_manWaveMaker
      ret = tb.sendTelemetryBool(		"imode_manWaveMaker", 			imode_manWaveMaker);
      tbtlmLog.verbose("ThingsBoard_Telemetry:: Msg %d :: Sent Data To %s :: Channel %s :: Value %T ::", ii,   THINGSBOARD_SERVER, 	"imode_manWaveMaker", 		imode_manWaveMaker);
      break;
    case 31: //imode_manPowerhead
      ret = tb.sendTelemetryBool(		"imode_manPowerhead", 			imode_manPowerhead);
      tbtlmLog.verbose("ThingsBoard_Telemetry:: Msg %d :: Sent Data To %s :: Channel %s :: Value %T ::", ii,   THINGSBOARD_SERVER, 	"imode_manPowerhead", 		imode_manPowerhead);
      break;
    case 32: //imode_manAutoFeeder
      ...
      break;
    case 33: //imode_manFreshwaterLight
      ret = tb.sendTelemetryBool(		"imode_manFreshwaterLight", 	imode_manFreshwaterLight);
      tbtlmLog.verbose("ThingsBoard_Telemetry:: Msg %d :: Sent Data To %s :: Channel %s :: Value %T ::", ii,   THINGSBOARD_SERVER, 	"imode_manFreshwaterLight", imode_manFreshwaterLight);
      break;
    case 34: //imode_Feed
      ret = tb.sendTelemetryBool(		"imode_manDosePump", 			imode_manDosePump);
      tbtlmLog.verbose("ThingsBoard_Telemetry:: Msg %d :: Sent Data To %s :: Channel %s :: Value %T ::", ii,   THINGSBOARD_SERVER, 	"imode_manDosePump", 		imode_manDosePump);
      break;
    case 35: //imode_Storm
